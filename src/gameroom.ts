...
export class GameRoom {
  ...
  private async stageClip(movieId: string, roundNumber: number): Promise<void> {
    ...
    const masterPlaylistUrl = `${this.env.EMBY_URL}/Videos/${movieId}/master.m3u8?MediaSourceId=${mediaSourceId}&Static=false&VideoCodec=h264&AudioCodec=aac&VideoBitRate=2000000&AudioBitRate=128000&MaxStreamingBitrate=2000000&PlaySessionId=${playSessionId}`;
